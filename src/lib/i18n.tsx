...
const translations: Record<Lang, Dict> = {
  es: {
    ...
    'act.move.getReady': 'Prepárate…',
    'act.move.go': '¡Ya!',
    'act.move.wellDone': '¡Bien hecho!',
    'act.move.nextReady': '¿Listos para el siguiente? ▶',
    'act.move.finish': 'Terminar ▶',
    ...
    'act.title.breathing': 'Respiración 4-7-8',
    'act.desc.breathing': 'Guía de respiración para relajar y centrar.',
    'act.title.memory': 'Juego de memoria',
    'act.desc.memory': 'Ejercicio divertido para fortalecer la concentración.',
    'act.title.sensory': 'Rompecabezas sensorial',
    'act.desc.sensory': 'Actividad táctil para estimular los sentidos.',
    'act.title.emotions': 'Diario de emociones',
    'act.desc.emotions': 'Registra sensaciones y reflexiona con calma.',
    'act.title.reading': 'Lectura guiada',
    'act.desc.reading': 'Tiempo de lectura con preguntas de comprensión.',
    'act.title.movement': 'Tiempo de movimiento',
    'act.desc.movement': 'Pequeños ejercicios para descargar energía positiva.',
    'auth.timeout': 'El servidor tardó en responder (puede estar despertando). Esperá unos segundos y volvé a intentar.',
    'auth.warming': 'Estamos despertando el servidor… esto puede tardar unos segundos ⏳',
    'auth.retrying': 'El servidor está tardando, reintentando…',
    'auth.noLogin': 'No se pudo iniciar sesión. Intentá de nuevo.',
    'auth.unexpected': 'Ocurrió un error inesperado. Intentá de nuevo.',
    'auth.needEmail': 'Escribe tu email para recibir el código de recuperación.',
    'auth.codeSent': 'Te enviamos un código de verificación a tu email. Redirigiendo...',
    'auth.back': '← Volver',
    'auth.forgotTitle': 'Olvidé mi contraseña',
    'auth.loginTitle': 'Inicia sesión',
    'auth.registerTitle': 'Crea tu cuenta',
    'auth.forgotSub': 'Envía el código a tu email y úsalo para crear una nueva contraseña.',
    'auth.loginSub': 'Accede con tu email y contraseña para gestionar actividades y progreso.',
    'auth.registerSub': 'Regístrate para crear un perfil cálido y personalizado para tu niño.',
    'auth.email': 'Email',
    'auth.sendingCode': 'Enviando código...',
    'auth.sendCode': 'Enviar código',
    'auth.backToLogin': 'Volver al login',
    'auth.parentName': 'Nombre del padre/madre',
    'auth.yourName': 'Tu nombre',
    'auth.password': 'Contraseña',
    'auth.forgotPassword': '¿Olvidaste tu contraseña?',
    'auth.childName': 'Nombre del hijo/a',
    'auth.childNamePlaceholder': 'Nombre del niño/a',
    'auth.childAge': 'Edad del hijo/a',
    'auth.agePlaceholder': 'Edad',
  ...
  en: {
    ...
    'act.move.getReady': 'Get ready…',
    'act.move.go': 'Go!',
    'act.move.wellDone': 'Well done!',
    'act.move.nextReady': 'Ready for the next one? ▶',
    'act.move.finish': 'Finish ▶',
    ...
    'act.title.breathing': '4-7-8 Breathing',
    'act.desc.breathing': 'A breathing guide to relax and center.',
    'act.title.memory': 'Memory game',
    'act.desc.memory': 'A fun exercise to strengthen focus.',
    'act.title.sensory': 'Sensory puzzle',
    'act.desc.sensory': 'A hands-on activity to stimulate the senses.',
    'act.title.emotions': 'Emotions diary',
    'act.desc.emotions': 'Record feelings and reflect calmly.',
    'act.title.reading': 'Guided reading',
    'act.desc.reading': 'Reading time with comprehension questions.',
    'act.title.movement': 'Movement time',
    'act.desc.movement': 'Small exercises to release positive energy.',
    'auth.timeout': 'The server took a while to respond (it may be waking up). Wait a few seconds and try again.',
    'auth.warming': 'We are waking up the server… this may take a few seconds ⏳',
    'auth.retrying': 'The server is taking a while, retrying…',
    'auth.noLogin': 'Could not sign in. Please try again.',
    'auth.unexpected': 'An unexpected error occurred. Please try again.',
    'auth.needEmail': 'Enter your email to receive the recovery code.',
    'auth.codeSent': 'We sent a verification code to your email. Redirecting...',
    'auth.back': '← Back',
    'auth.forgotTitle': 'I forgot my password',
    'auth.loginTitle': 'Sign in',
    'auth.registerTitle': 'Create your account',
    'auth.forgotSub': 'Send the code to your email and use it to create a new password.',
    'auth.loginSub': 'Sign in with your email and password to manage activities and progress.',
    'auth.registerSub': 'Sign up to create a warm, personalized profile for your child.',
    'auth.email': 'Email',
    ...
    'auth.childName': 'Child name',
    'auth.childNamePlaceholder': 'Child name',
    'auth.childAge': 'Child age',
    'auth.agePlaceholder': 'Age',
  ...
  pt: {
    ...
    'act.move.getReady': 'Prepare-se…',
    'act.move.go': 'Já!',
    'act.move.wellDone': 'Muito bem!',
    'act.move.nextReady': 'Pronto para o próximo? ▶',
    'act.move.finish': 'Concluir ▶',
    ...
    'act.title.breathing': 'Respiração 4-7-8',
    'act.desc.breathing': 'Guia de respiração para relaxar e se centrar.',
    'act.title.memory': 'Jogo da memória',
    'act.desc.memory': 'Exercício divertido para fortalecer a concentração.',
    'act.title.sensory': 'Quebra-cabeça sensorial',
    'act.desc.sensory': 'Atividade tátil para estimular os sentidos.',
    'act.title.emotions': 'Diário de emoções',
    'act.desc.emotions': 'Registre sensações e reflita com calma.',
    'act.title.reading': 'Leitura guiada',
    'act.desc.reading': 'Tempo de leitura com perguntas de compreensão.',
    'act.title.movement': 'Tempo de movimento',
    'act.desc.movement': 'Pequenos exercícios para liberar energia positiva.',
    'auth.timeout': 'O servidor demorou para responder (pode estar acordando). Aguarde alguns segundos e tente de novo.',
    'auth.warming': 'Estamos acordando o servidor… isso pode levar alguns segundos ⏳',
    'auth.retrying': 'O servidor está demorando, tentando de novo…',
    'auth.noLogin': 'Não foi possível entrar. Tente de novo.',
    'auth.unexpected': 'Ocorreu um erro inesperado. Tente de novo.',
    'auth.needEmail': 'Digite seu email para receber o código de recuperação.',
    'auth.codeSent': 'Enviamos um código de verificação para seu email. Redirecionando...',
    'auth.back': '← Voltar',
    'auth.forgotTitle': 'Esqueci minha senha',
    'auth.loginTitle': 'Entrar',
    'auth.registerTitle': 'Crie sua conta',
    'auth.forgotSub': 'Envie o código para seu email e use-o para criar uma nova senha.',
    'auth.loginSub': 'Entre com seu email e senha para gerenciar atividades e progresso.',
    'auth.registerSub': 'Cadastre-se para criar um perfil acolhedor e personalizado para seu filho.',
    'auth.email': 'Email',
    'auth.sendingCode': 'Enviando código...',
    'auth.sendCode': 'Enviar código',
    'auth.backToLogin': 'Voltar para o login',
    'auth.parentName': 'Nome do responsável',
    'auth.yourName': 'Seu nome',
    'auth.password': 'Senha',
    'auth.forgotPassword': 'Esqueceu sua senha?',
    'auth.childName': 'Nome da criança',
    'auth.childNamePlaceholder': 'Nome da criança',
    'auth.childAge': 'Idade da criança',
